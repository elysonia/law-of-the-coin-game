...
func start_current_trial_effects():
	...
	if (
		_modifier.trial_effects.button_mash_time_increase + GlobalEnums.DEFAULT_BUTTON_MASH_TIME
		> GlobalLevelState.level_button_mash_time.value
	):
		GlobalLevelState.level_button_mash_time = {
			value = _modifier.trial_effects.button_mash_time_increase + GlobalEnums.DEFAULT_BUTTON_MASH_TIME,
